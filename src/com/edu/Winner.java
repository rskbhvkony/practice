...
public class Winner {
	 ...
	 private int year;
	    ...
	    Winner(int year, String nationality, String name, String team, int lengthKm, Duration winningTime, int daysInYellow) {
	        this.year = year;
	    ...
	    public static final List<Winner> tdfWinners = Arrays.asList(
	    		...
	    		new Winner(2024, "Great Britain", "A Wiggins", "A Team Sky", 3496, Duration.parse("PT87H34M47S"), 97),
	    		new Winner(2024, "Great Britain", "B Wiggins", "B Team Sky", 3496, Duration.parse("PT87H34M47S"), 98),
	    		new Winner(2024, "Great Britain", "C Wiggins", "C Team Sky", 3496, Duration.parse("PT87H34M47S"), 99));
